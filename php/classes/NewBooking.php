...
class NewBooking
{
    ...
    public function __construct()
    {
        ...
        if (isset($_POST['createBooking'])) {
			...
			{
				if( isset($_POST['instrumentId']) && $_POST['instrumentId'][0] == "i" ){
				...
				}else if( isset($_POST['instrumentId']) && $_POST['instrumentId'][0] == "c" ){
    ...
    private function newInstrumentBooking($userId, $projectId, $instrumentId, $dateFrom, $dateTo, $timeFrom, $timeTo)
    {
		...
		if( $this->instrumentNotOverlapping($dateFrom, $dateTo, $timeFrom, $timeTo, $instrumentId) ){
            ...
            if( $this->notPastCurrentDate($dateFrom, $timeFrom)){
		        ...
		        if ($this->databaseConnection()) {
	        		...
	        		$query = $this->db_connection->prepare('INSERT INTO instrumentBookings (userId, projectId, instrumentId, dateFrom, dateTo, timeFrom, timeTo) VALUES (:userId, :projectId, :instrumentId, :dateFrom, :dateTo, :timeFrom, :timeTo)');
