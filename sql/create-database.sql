...
#
# Database: _ims
# Generation Time: 2016-05-27 15:23:22 +0000
# ************************************************************
...
CREATE TABLE `bookingLog` (
  ...
  `modifiedByName` varchar(100) DEFAULT NULL,
  `ipAddress` varchar(20) DEFAULT NULL,
  `modifiedId` int(11) DEFAULT NULL,
  `originalJSON` varchar(2000) DEFAULT NULL,
...
CREATE TABLE `invoiceBooking` (
  ...
  `primaryInvestigator` varchar(100) NOT NULL DEFAULT '',
  `institution` varchar(100) NOT NULL DEFAULT '',
  `addressOne` varchar(50) NOT NULL DEFAULT '',
  `addressTwo` varchar(50) NOT NULL DEFAULT '0',
  ...
  `pmntPurchaseOrder` varchar(20) DEFAULT NULL,
  `pmntProjectCostingBusinessUnit` varchar(20) DEFAULT NULL,
  `pmntProjectId` varchar(20) DEFAULT NULL,
  `pmntDepartmentId` varchar(20) DEFAULT NULL,
  `projectId` int(11) DEFAULT NULL,
  `bookingId` int(11) NOT NULL,
  `instrumentId` int(11) NOT NULL,
  `instrumentName` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE `users` (
  ...
  `createdAt` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` timestamp NULL DEFAULT '0000-00-00 00:00:00',
  `accountDisabled` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
